    ...
    <div class="container">
        <div class="row justify-content-middle" style="margin-left: 397px;">
            <div class="col-md-6 mt-5">
                <form method="post" action="success.php" class="appointment-form" enctype="multipart/form-data" style="margin-top: -668px;">
                    ...
                    <div class="row">
                        ...
                        <div class=" col-md-12">
                            <div class="form-group">
                                <input type="submit" name="register" class="btn btn-primary py-3 px-4">
                            </div>
                        </div>
                    </div>
                </form>
